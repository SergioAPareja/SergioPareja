  ...
  Heavily based on ADC1 and my code from Skill 8 Example
  */
  #include <stdio.h>
  #include <stdlib.h>
  #include <math.h>
  ...
  static void display() {
      ...
      while (1) {
        char V[4];
        V[0] = floor(voltage/1000) + 48;
        V[1] = floor(voltage/100) + 48 - floor(voltage / 1000) * 10;
        V[2] = floor(voltage/10) + 48 - floor(voltage / 100) * 10;
        V[3] = floor(voltage) + 48 - floor(voltage / 10) * 10;


        displaybuffer[0] = alphafonttable[(int)V[0]];
        displaybuffer[1] = alphafonttable[(int)V[1]];
        displaybuffer[2] = alphafonttable[(int)V[2]];
        displaybuffer[3] = alphafonttable[(int)V[3]];
  ...
  void app_main(void)
  {
      ...
      while (1) {
          ...
          float temp = 1/20 + 1/34.35 * log(voltage*30/50000);
